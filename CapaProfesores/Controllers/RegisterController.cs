...
namespace CapaProfesores.Controllers
{
    public class RegisterController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Registro(string txtNombre, string txtApellido, string txtTel, string txtDni, DateTime txtNacimiento, string typeofuser, string txtMail, string txtPass1, string txtPass2)
        {
